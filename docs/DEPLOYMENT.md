...
3. Import the repository in Vercel with `frontend` as the Root Directory. Do not create separate frontend/backend projects.
4. Vercel reads `vercel.json`: build command `npm run build`, output directory `dist`.
